...
namespace ManagementOfExams.Controllers
{
    public class TeachersController : Controller
    {
        ...
        public TeachersController(ManagementContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,UserName,Password,EmailAddress")] Teacher teacher)
        {
